 ...
 * @private @method statusCodeErrorHandlerFactory
 * 
 * @param {string} where 
 ...
 * @private @method requestErrorHandlerFactory
 * 
 * @param {string} where 
 ...
 * @public @method module:controller.auth.login
 * @alias auth_login
 * 
 * @param {string} username 
 * @param {string} password 
 * @returns {Promise.< Object.<string, Station> | module:controller.code~Code >}
 */
...
/**
 * Ping AUTH server.
 * @public @method module:controller.auth.ping
 * @alias auth_ping
 * 
 * @param {string} auth_api_token 
 * @returns {Promise.<|module:controller.code~Code>}
 */
 ...
 * @public @method module:controller.auth.authenticate
 * @alias auth_authenticate
 * 
 * @param {string} auth_api_token 
 * @param {string} student_id Student id
 * @param {string} card_id Mifare Classic card id
 * @returns {Promise.< Object.<string,Student> | module:controller.code~Code >}
 */
 ...
 * @public @method module:controller.auth.confirm
 * @alias auth_confirm
 * 
 * @param {string} auth_api_token
 * @param {string} student_id
 * @param {string} vote_token
 * @returns {Promise.<auth_confirm~ConfirmReturns|module:controller.code~Code>}
 */
...
/**
 * Reject a student.
 * @public @method module:controller.auth.reject
 * @alias auth_reject
 * 
 * @param {string} auth_api_token 
 * @param {string} student_id 
